        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane. Pityful a rethoric question
                        ran over her cheek, then she continued her way.</p>
                    <div class="row g-1 my-5">
                        <div class="col-lg-4">
                            <a href="images/post_lg_1.jpg" class="glightbox"><img src="images/post_lg_1.jpg" alt="Image" class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_2.jpg" class="glightbox"><img src="images/post_lg_2.jpg" alt="Image" class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_3.jpg" class="glightbox"><img src="images/post_lg_3.jpg" alt="Image" class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_4.jpg" class="glightbox"><img src="images/post_lg_4.jpg" alt="Image" class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_1.jpg" class="glightbox"><img src="images/post_lg_1.jpg" alt="Image" class="img-fluid rounded"></a>
                        </div>
